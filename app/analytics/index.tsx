...
const DATE_RANGE_OPTIONS = [
    ...
    { label: 'Custom Date...', value: 'custom' }, // Changed label
];
...
const AnalyticsScreen: React.FC = () => {
    ...
    // Simplified state for a single date picker
    ...
    const handleConfirmDate = (date: Date) => {
        ...
        setSelectedRange({
            label: date.toLocaleDateString('en-GB'), // e.g., "23/07/2025"
            value: 'custom',
        });
    };
