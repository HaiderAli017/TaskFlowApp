...
import FocusTimerSettingsScreen, { TimerSettings } from '../focusTimerSetting';
...
const FocusTimerScreen: React.FC = () => {
    ...
    useFocusEffect(
        useCallback(() => {
            ...
            RNStatusBar.setBackgroundColor(isDarkMode ? '#1F2937' : '#6443FE', true);
        }, [isDarkMode])
    );
    ...
    return (
        <>
            <SafeAreaView
                ...
                style={{ backgroundColor: isDarkMode ? '#111827' : '#5937F9' }}
            >
                ...
                <View className="flex-1 justify-center items-center px-5">
                    <View className={`flex-row p-1 rounded-full mb-12 ${isDarkMode ? 'bg-white/20' : 'bg-white/20'}`}>
                    ...
                    <View className="flex-row items-center justify-center mt-12" style={{ gap: 25 }}>
                        ...
                        <TouchableOpacity onPress={handleStartPause} className={`w-20 h-20 rounded-full items-center justify-center shadow-lg`} style={{ backgroundColor: isActive ? '#5F3EFE' : '#fff' }}>
                            {isActive ? (
